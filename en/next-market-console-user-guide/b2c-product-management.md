...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/pt4moEMpSf4BGvjJCzQm/next-market-console-user-guide/b2c-product-management
---
...
Sections can be used when there are multiple product types or when differentiation between items is needed.
...
| Refund Type        | <ul><li><p>Select according to game refund policy</p><ul><li>Non-refundable</li><li>Refundable</li><li>Partial Refund</li></ul></li></ul>                                                                                                                                                                                                                                                                |
...
| Shipping Type        | <ul><li><p>Select the shipping method to be used for purchases</p><ul><li>Automatic Shipping: System automatically ships upon purchase completion</li><li>Manual Shipping: Ship manually at a specific time after purchase completion</li></ul><p>⚠️ Manual shipping requires prior consultation with LINE NEXT</p></li></ul>                                                                                                                                                                                                                    |
| Display Order        | <ul><li>Enter the display order of products within the section</li></ul>                                                                                                                                                                                                                                                                                                                                                    |
| Adult Verification Required     | <ul><li>Enable if the product requires adult verification</li><li>Product images will not be displayed before age verification; they will display normally after verification</li><li>Example image (before adult verification)</li></ul><div><figure><img src="../../.gitbook/assets/B2C 상품 등록_성인인증.png" alt="" width="133"><figcaption></figcaption></figure></div>                                                                                                                  |
...
| Reset Basis Date    | <ul><li>Enter the reference time when reset will apply for periodic sales settings</li><li>Enter in yyyy-MM-dd HH:mm format</li><li><p>Example Settings</p><ul><li><p>Registered as a past point relative to the opening date</p><ul><li>None: No setting required</li><li>Opening date: 2025-12-16 10:00 KST (Tuesday)</li><li>Daily: 2025-12-15 10:00 KST = Reset daily at 10:00</li><li>Weekly: 2025-12-09 10:00 KST = Reset weekly at 10:00 KST on Tuesday</li><li>Monthly: 2025-12-01 10:00 KST = Resets at 10:00 AM on the 1st of each month</li></ul></li></ul></li></ul> |
...
<figure><img src="../../.gitbook/assets/B2C 상품 등록_아이템.png" alt=""><figcaption></figcaption></figure>{% endstep %}
{% endstepper %}
