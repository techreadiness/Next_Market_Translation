...
*   Provided Functions \*[섹션 등록](https://next-market-admin.gitbook.io/next-market-docs/api/undefined-3#post-api-v1-sale-b2c-section)
...
Sections are **classification areas for displaying B2C products in groups**. Sections can be used when there are multiple product types or when differentiation between items is needed.
...
<figure><img src="../../.gitbook/assets/B2C 상품 관리_섹션 등록.png" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
* Enter the reference time when reset will apply for periodic sales settings
...
<figure><img src="../../.gitbook/assets/B2C 상품 등록_판매 기간.png" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
<figure><img src="../../.gitbook/assets/B2C 상품 등록_아이템.png" alt=""><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}
...
<figure><img src="../../.gitbook/assets/B2C 상품 등록_수정.png" alt=""><figcaption></figcaption></figure>
