...
A mission's operation method and reward distribution structure vary based on the mission type + round (instance) + achievement goal settings. Please select the mission type that best suits your purpose by referring to the examples below.
