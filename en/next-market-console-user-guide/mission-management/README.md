...
* Save after modifying mission information
...
| Total Limit   | <ul><li><p>Enter the total budget allocated to the mission</p><ul><li>USDt: Enter quantity</li><li>SKU: Enter the number</li></ul></li></ul> |
