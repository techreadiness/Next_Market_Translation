...
* NEXT Market Console is an **administrative tool that provides key API functions offered by NEXT Market in a web-based console format**.
* It supports **easy and intuitive registration and management of items, products, missions, etc.** during development and operation.
* Access to the Console requires a **console-specific API Key**.
* If you wish to use the Console, **please request it from NEXT Market in advance**. After verification, we will **support issuing a dedicated API Key**.
