...
Only hyphens (-) are permitted for lowercase letters, numbers, and special characters.
...
It is displayed in PC environments and is hidden only in mobile/pad environments as described above.
...
Please refer to the following guide document for details. ([가이드](https://next-market-admin.gitbook.io/next-market-docs/api/undefined-8#market-webview)
...
<summary>Are there any precautions for Preview testing?</summary>
