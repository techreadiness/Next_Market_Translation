...
| 403         | NOT_ALLOWED                                                        | Unauthorized API path                                                                |
...
| MAINTENANCE             | Maintenance                        | Temporary/scheduled maintenance state                                 |
...
A 406 error response is returned when the issue lies in client-side input and cannot be resolved with the same input parameters.
